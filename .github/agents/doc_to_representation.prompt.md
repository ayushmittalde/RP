---
name: documentation-to-structured-representation
...
In the panel tell the user when you have completed the task and provide the path to the file where the output is stored. Never output the analysis directly in the panel.